...
$Lines = Set-DotEnvValue -Content $Lines -Key "OLLAMA_KEEP_ALIVE" -Value "2m"
$Lines = Set-DotEnvValue -Content $Lines -Key "OLLAMA_TIMEOUT" -Value "120"
